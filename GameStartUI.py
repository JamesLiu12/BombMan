        ...
        for i in range(len(menul)):
            if i < len(menul)-1:
                if i != choice:
                    ...
                    print(Fore.RED+Back.BLACK+menul[i],str(self.settingUI.playersSates[i]),end='')
                    print()
                else:

                    print(Fore.RED+menul[i],Fore.RED+Back.WHITE+str(self.settingUI.playersSates[i]),end = '')
                    print()
            else:
                if i != choice:
